...
namespace Chatter.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(IFormFile file, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ChatterUser { UserName = Input.Email, Email = Input.Email, ChatterName = Input.ChatterName, Avatar = file != null ? file.FileName : "-" };
